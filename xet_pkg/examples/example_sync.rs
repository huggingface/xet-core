...
fn upload_files(files: Vec<PathBuf>, endpoint: Option<String>) -> Result<(), GenericError> {
...
fn download_files(metadata_file: PathBuf, output_dir: PathBuf, endpoint: Option<String>) -> Result<(), GenericError> {
