...
// Re-export for external configuration suggestion.
pub use cas_client::DEFAULT_BLOCK_SIZE;

pub(crate) async fn create_cas_client(
...
pub(crate) async fn data_from_chunks_to_writer(
    cas: &Arc<dyn Staging + Send + Sync>,
    prefix: String,
