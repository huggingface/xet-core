...
// The wire contract of `POST /v1/xorbs/grants`, mirrored in xetcas `cas_server/src/direct_upload.rs`
// until xetcas bumps its xet-core rev and imports these types from here.
