...
use base64::Engine;
use xet_core_structures::serialization_utils::{read_u32, read_u64, write_u32, write_u64};

use super::super::error::ChunkCacheError;
...
mod tests {
    ...
    use super::super::BASE64_ENGINE;
    use super::{CACHE_ITEM_FILE_NAME_BUF_SIZE, CacheItem};
    use crate::cas_types::ChunkRange;
